...
import com.whitehacker.utils.MidnightApplicationRefresh;
...
public class LibraryManagementSystemApplication {
	...
	CommandLineRunner runner() {
		return args -> {
			...
			User user1 = new User("admin", pwEncoder.encode("test"), "muslim.whitehacker@gmail.com", "Vafo", "Tagoyev", "Yoshlik street, 125/3", "992006671", "Jizzakh");
			user1.setRole("ROLE_ADMIN");

			User user2 = new User("employee", pwEncoder.encode("test"), "vafo.tagayev@gmail.com", "Muslim", "Abdullah", "Moskvorechye, dom2, korpus1", "89771372349", "Moscow");
